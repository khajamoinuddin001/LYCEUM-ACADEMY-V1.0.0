...
import { ArrowLeft, BookOpen } from '@/components/common/icons'; // Assuming BookOpen is in icons, if not will use Lucide default import or fix later
import type { Contact, User, LmsCourse } from '@/types';
import { StudentProgressModal } from '@/features/lms/course_analytics_view';
