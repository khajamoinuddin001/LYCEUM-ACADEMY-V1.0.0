...
import { GraduationCap, Plus, History, FileText, Users, BookOpen, TrendingUp, Target } from '@/components/common/icons';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 md:p-8 mb-8 border border-gray-100 dark:border-gray-700">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <button
              ...
              className="flex items-center px-6 py-3 bg-gradient-to-r from-lyceum-blue to-blue-600 text-white rounded-2xl font-semibold hover:shadow-2xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 hover:-translate-y-1"
            >
        ...
        {/* Tab Navigation */}
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-2 mb-8 border border-gray-100 dark:border-gray-700">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl p-6 md:p-8 border border-gray-100 dark:border-gray-700">
          {activeTab === 'questions' ? (
            ...
            <SessionHistory contacts={allContacts} />
          ) : (
