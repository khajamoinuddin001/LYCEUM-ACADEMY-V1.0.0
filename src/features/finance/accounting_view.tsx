...
const AccountingView: React.FC<AccountingViewProps> = ({
    ...
    // If viewing accounts receivable, show the detailed view
    ...
    // If viewing overdue payments, show the detailed view
    if (viewMode === 'overdue') {
        return (
            <OverduePaymentsView
                transactions={transactions}
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div
                        ...
                        className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-orange-500 cursor-pointer hover:shadow-lg transition-shadow"
                    >
                        <div className="flex items-center justify-between">
                            <div>
                    ...
                    <div
                        ...
                        className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border-l-4 border-red-600 cursor-pointer hover:shadow-lg transition-shadow"
                    >
                        <div className="flex items-center justify-between">
                            <div>
