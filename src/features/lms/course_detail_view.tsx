...
import { ArrowLeft, BookOpen, ChevronDown, CheckCircle2, Circle, Video, Plus, Edit, Trash2, X, Paperclip, FileQuestion, BarChart3, GraduationCap, IndianRupee, FileText, MessageCircle, UserPlus } from '@/components/common/icons';
