-- CONSOLIDATED MIGRATION: Support Ticket System & Counselor Column Fix
-- This script ensures all necessary tables and columns exist for the Support Ticket system
-- and fixes the missing counselor_assigned_2 column in the contacts table.
...
-- 2. Add resolution_notes column to tickets if it's missing (for existing tables)
DO $$ 
BEGIN 
...
-- 6. Add counselor_assigned_2 to contacts table
DO $$ 
BEGIN 
